...
function App() {
    ...
    return <div className="flex flex-col justify-center items-center p-4">
        ...
        <div className="w-full flex flex-col text-center">
            ...
            <input onChange={(e) => {handleH1(e.target.value)}} className="text-black my-2 text-center" placeholder='input'/>
            <h1 className="mb-2">{h1}</h1>
            <h2>{h2}</h2>
            <textarea onChange={(e) => {handleH2(e.target.value)}} className="text-black my-2 text-center" placeholder='textarea'/>
        </div>
